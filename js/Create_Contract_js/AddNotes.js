(function () {
  const items = [
    {
      id: "Fuel",
      label: "الوقود",
      options: ["ممتلئ", "3/4", "1/2", "1/4", "فارغ"],
    },
    {
      id: "Air_conditioner",
      label: "التكييف",
      options: ["ممتاز", "جيد", "ضعيف", "لا يعمل", "موجود", "غير موجود"],
    },
    {
      id: "Radio_Recorder",
      label: "الراديو / المسجل",
      options: ["ممتاز", "جيد", "ضعيف", "لا يعمل", "موجود", "غير موجود"],
    },
    {
      id: "Internal_Screen",
    ...
    {
      id: "Lights_Signals",
      label: "الانوار و إشارات الانعطاف",
      options: ["ممتاز", "جيد", "ضعيف", "لا يعمل", "موجود", "غير موجود"],
    },
    {
      id: "Wipers",
  ...
  function refreshCellVisual(itemId) {
    ...
    if (corner) {
      corner.classList.toggle("has-note", hasNote);
    }
  }
  ...
  function showPopover(cell, itemId) {
    ...
    pop.innerHTML = `${notes[itemId] || ""}<span class="note-edit-link">تعديل</span>`;
  ...
  document
    .getElementById("All_Check_items")
